...
public class CalculandoVendas {
	...
	public static void main(String[] args) {
		...
		System.err.print("\tVAREJÃO DA TAINÁ Ltda.\n");
		
		System.out.print("\nInsira qualquer número para adicionar novo produto ou -1 para encerrar.");
		...
		System.out.printf("%n%nPreço de varejo de cada produto: "
