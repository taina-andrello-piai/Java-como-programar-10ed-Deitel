...
/*(Programa para impressão de triângulos) 
 * Escreva um aplicativo que exibe os seguintes padrões separadamente, um embaixo do outro.
 * Utilize loops for para gerar os padrões. Todos os asteriscos (*) devem ser impressos por uma 
 * única instrução na forma System.out.print('*'); 
 ...
 * Uma instrução na forma System.out.print(' '); pode ser utilizada para exibir um espaço para os 
 * últimos dois padrões. Não deve haver outras instruções de saída no programa. 
